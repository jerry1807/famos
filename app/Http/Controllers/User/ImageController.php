	...
	*/
	public function process(Request $request) 
    {
        if ($request->ajax()) {
            ...
            if($verify['data']!=633855){return false;}
    ...
    public function activeEngine($engine, $vendor)
    {
        ...
        if ($engine == 'none' && $vendor == 'sd') {
            switch (config('settings.image_stable_diffusion_engine')) {
                case 'stable-diffusion-v1-5': return 'Stable Diffusion v1.5'; break;
                case 'stable-diffusion-512-v2-1': return 'Stable Diffusion v2.1'; break;
                case 'stable-diffusion-768-v2-1': return 'Stable Diffusion v2.1-768'; break;
