...
use App\Models\Aimedchat;
use Illuminate\Http\Request;

class AimedChatController extends Controller
{
    // Display the AI web chat view
    public function index()
    {
        $chatHistory = Aimedchat::where('user_id', auth()->user()->id)->get();
    ...
    {
        if ($request->ajax()) {
            $chat = Aimedchat::where('message_code', $request->input('code'))->first();
