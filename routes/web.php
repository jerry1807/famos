...
use App\Http\Controllers\AidashController;
use App\Http\Controllers\AimedChatController;
use App\Http\Controllers\AibotController;
use App\Http\Controllers\GmailWidgetController;
use App\Http\Controllers\MydriveController;
use App\Http\Controllers\GoogleCalendarController;
use App\Http\Controllers\PostSchedulerController;
use App\Http\Controllers\CommunicationsController;
use App\Http\Controllers\MyintegationsController;
...
Route::middleware(['auth'])->group(function () {
    // Route to initiate the Google Calendar connection
...
Route::get('/emailcomposer', [GmailWidgetController::class, 'index'])->name('user.emailcomposer');

Route::middleware(['auth'])->group(function () {
    // Display the Gmail widget index page
    Route::get('/gmail-widget', [GmailWidgetController::class, 'index'])->name('gmail-widget.index');

    // Connect to Gmail
    Route::get('/gmail-widget/connect', [GmailWidgetController::class, 'connect'])->name('gmail-widget.connect');

    // Handle Google OAuth callback
    Route::get('/gmail-widget/callback', [GmailWidgetController::class, 'handleGoogleCallback'])->name('gmail-widget.callback');

    // Get Gmail account details
    Route::get('/gmail-widget/account-details', [GmailWidgetController::class, 'getGmailAccountDetails'])->name('gmail-widget.account-details');

    // Send an email using Gmail
    Route::post('/gmail-widget/send-email', [GmailWidgetController::class, 'sendEmail'])->name('gmail-widget.send-email');

    // Fetch new emails from Gmail
    Route::get('/gmail-widget/fetch-new-emails', [GmailWidgetController::class, 'fetchNewEmails'])->name('gmail-widget.fetch-new-emails');
});
...
Route::get('/instagram/redirect', [InstagramPageController::class, 'redirectToInstagram'])->name('instagram.redirect');
Route::get('/instagram/callback', [InstagramPageController::class, 'handleInstagramCallback'])->name('instagram.callback');


Route::get('/facebook/connect', 'FacebookPageController@redirectToFacebook')->name('facebook.connect');
Route::get('/facebook/redirect', [FacebookPageController::class, 'redirectToFacebook'])->name('facebook.redirect');
Route::get('/facebook/callback', [FacebookPageController::class, 'handleFacebookCallback'])->name('facebook.callback');
...
//AIWEBCHAT
Route::get('user/aiwebchat', [AiWebChatController::class, 'index'])->name('user.aiwebchat.index');
Route::post('user/aiwebchat/delete', [AiWebChatController::class, 'delete'])->name('aiwebchat.delete');
Route::post('user/aiwebchat/rename', [AiWebChatController::class, 'rename'])->name('aiwebchat.rename');
Route::post('user/aiwebchat/save', [AiWebChatController::class, 'saveChat'])->name('aiwebchat.save');
Route::get('aiwebchat/history', [AiWebChatController::class, 'getChatHistory'])->name('aiwebchat.history');

//AIMEDCHAT
Route::get('user/aimedchat', [AimedChatController::class, 'index'])->name('user.aimedchat.index');


//AIBOTS
Route::get('/aibots', [AibotController::class, 'index'])->name('user.aibots');
