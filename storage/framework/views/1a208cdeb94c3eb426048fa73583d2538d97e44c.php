							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="input-box">	
									...
									<select id="default-model-admin" name="default-model-admin" class="form-select" data-placeholder="<?php echo e(__('Select Default Model')); ?>:">			
										<option value="text-davinci-003" <?php if( config('settings.default_model_admin')  == 'text-davinci-003'): ?> selected <?php endif; ?>><?php echo e(__('Davinci')); ?> (<?php echo e(__('GPT 3')); ?>) (<?php echo e(__('Legacy')); ?>)</option>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">	
											...
											<select id="default-model-user" name="default-model-user" class="form-select" data-placeholder="<?php echo e(__('Select Default Model')); ?>:">			
												<option value="text-davinci-003" <?php if( config('settings.default_model_user')  == 'text-davinci-003'): ?> selected <?php endif; ?>><?php echo e(__('Davinci')); ?> (<?php echo e(__('GPT 3')); ?>) (<?php echo e(__('Legacy')); ?>)</option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/davinci/configuration/index.blade.php ENDPATH**/ ?>