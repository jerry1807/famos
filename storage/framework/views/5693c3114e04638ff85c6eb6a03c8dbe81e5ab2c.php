    ...
    <ul class="side-menu app-sidebar3">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="<?php echo e(url('#')); ?>">
                ...
                <ul class="slide-menu">
                    <li><a href="<?php echo e(route('user.aifiles')); ?>" class="slide-item"><?php echo e(__('Add files')); ?></a></li>
                    <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'user|subscriber')): ?>
                        <?php if(config('settings.image_feature_user') == 'allow'): ?>
...
<!-- END SIDE MENU BAR -->
<?php /**PATH /var/www/html/resources/views/layouts/nav-aside.blade.php ENDPATH**/ ?>