...
<div class="page-header mt-5-7">
	<div class="page-leftheader">
		...
		<ol class="breadcrumb mb-2">
			...
			<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(url('#')); ?>"> <?php echo e(__('Transcribe Results')); ?></a></li>
		</ol>
	</div>
</div>
<!-- END PAGE HEADER -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/user/documents/transcribe/index.blade.php ENDPATH**/ ?>