					...
					<div class="card-body">
						<div class="row">
							<div class="col-lg-6 col-md-12 col-sm-12">
								...
								<p class="fs-12"><?php echo e(__('Google Authenticator is a multifactor authentication application for mobile devices. It generates timed codes used during the 2-step verification process. To use Google Authenticator, install the Google Authenticator app on your mobile device.')); ?></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/user/profile/google.blade.php ENDPATH**/ ?>