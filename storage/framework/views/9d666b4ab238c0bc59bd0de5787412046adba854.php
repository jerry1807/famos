            ...
            <div class="col-md-12">
                <div class="section-title">
                    ...
                    <div class="text-center mb-9 mt-9 pt-7" id="contact-row">
                        ...
                        <h6 class="fs-30 mt-6 font-weight-bold text-center"><?php echo e(__('Privacy Policy')); ?></h6>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/privacy-policy.blade.php ENDPATH**/ ?>