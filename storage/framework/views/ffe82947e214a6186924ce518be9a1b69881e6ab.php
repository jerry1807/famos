			...
			<div class="changelogs">
				...
				<div class="changelog">
					...
					<div class="changelog-description mt-6">
						<ul>
							<li><span class="version-fix mr-2">Update</span> <span class="text-muted fs-13">Correct language reponse in AI Article Wizard updated</span></li>																																										
							<li><span class="version-fix mr-2">Update</span> <span class="text-muted fs-13">Image vendor can be selected or completely turned off for AI Article Wizard</span></li>																																										
							<li><span class="version-fix mr-2">Update</span> <span class="text-muted fs-13">Advanced options for AI Wizard keeps the changes till the end</span></li>																																										
				...
				<div class="changelog">
					...
					<div class="changelog-description mt-6">
						<ul>
							...
							<li><span class="version-fix mr-2">Update</span> <span class="text-muted fs-13">Requirement for symlink removed (new installations only)</span></li>	
							<li><span class="version-fix mr-2">Update</span> <span class="text-muted fs-13">Referral supported for social media logins and registrations</span></li>	
							<li><span class="version-fix mr-2">Update</span> <span class="text-muted fs-13">Registered via emails initially can now login with their social media accounts as well</span></li>	
							<li><span class="version-fix mr-2">Update</span> <span class="text-muted fs-13">Removed support for deprecated SD models: stable-diffusion-v1-5, stable-diffusion-512-v2-1, stable-diffusion-768-v2-1</span></li>	
							<li><span class="version-fix mr-2">Update</span> <span class="text-muted fs-13">Added support for new SD model: stable-diffusion-v1-6</span></li>	
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/settings/upgrade/index.blade.php ENDPATH**/ ?>