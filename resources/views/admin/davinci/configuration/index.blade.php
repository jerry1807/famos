							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="input-box">	
									...
									<select id="default-model-admin" name="default-model-admin" class="form-select" data-placeholder="{{ __('Select Default Model') }}:">			
										<option value="text-davinci-003" @if ( config('settings.default_model_admin')  == 'text-davinci-003') selected @endif>{{ __('Davinci') }} ({{ __('GPT 3') }}) ({{ __('Legacy') }})</option>
									...
									<div class="col-lg-6 col-md-6 col-sm-12">
										<div class="input-box">	
											...
											<select id="default-model-user" name="default-model-user" class="form-select" data-placeholder="{{ __('Select Default Model') }}:">			
												<option value="text-davinci-003" @if ( config('settings.default_model_user')  == 'text-davinci-003') selected @endif>{{ __('Davinci') }} ({{ __('GPT 3') }}) ({{ __('Legacy') }})</option>
